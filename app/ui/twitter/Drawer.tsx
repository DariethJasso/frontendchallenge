...
export default function Drawer(){
    ...
    return (
        <div className="bg-black w-full h-[50px] sm:flex sm:flex-col sm:w-[120px] sm:h-screen sm:items-center sm:fixed lg:w-[300px] lg:items-start lg:pl-5 xl1:w-[420px] xl1:pl-[130px] border-r-1 border-gray-300/25">
            <div className={`flex justify-center p-2 h-[50px] ${isSticky ? 'hidden' : ''} sm:relative sm:pt-3`}>
            ...
            <div className={`fixed bottom-0 top-0 p-2  w-full h-[50px] ${isSticky ? 'hidden' : ''}  sm:w-[50px] sm:relative sm:mt-[180px]`}>

                <Avatar src="https://i.pravatar.cc/150?u=a042581f4e29026024d" size="sm" className="sm:w-[50px] sm:h-[50px]"  />
            </div>
            <div className={`md:hidden fixed bottom-0 top-0 left-[370px] p-2   w-full h-[50px] ${isSticky ? 'hidden' : ''} sm:left-[600px] sm:z-50`}>
